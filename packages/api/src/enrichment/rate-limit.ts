 ...
 * Good enough for dogfood; design calls for a DDB token bucket before prod
 * live places (typeahead multiplies call volume and multi-instance Lambda
 * under/over-enforces a global 60/h). Tracked for PR 17 observability.
 */
